      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSection('Blood Sugar Monitoring', Icons.analytics, Colors.teal, [
            _buildContentCard('Target Levels',
                'Before meals: 80-130 mg/dL\nAfter meals: <180 mg/dL\nA1C: <7%',
                Icons.track_changes, Colors.teal),
          ]),
        ],
      ),
    );
